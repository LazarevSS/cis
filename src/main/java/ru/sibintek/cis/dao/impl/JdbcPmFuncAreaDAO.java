...
public class JdbcPmFuncAreaDAO implements PmFuncAreaDAO {
    ...
    public List<FunctionAndRelatedJoin> getFunctionAndRelatedJoins(Integer faId) {
        String sqlQuery = "with a as (\n" +
                ...
                "      )\n" +
                "      select distinct \n" +
                "        a.fa_id, a.fa_name, a.fu_id, a.fu_name,  join_type, b.fu_id jfu_id, b.fu_name jfu_name, b.fa_id jfa_id, b.fa_name jfa_name\n" +
                "      from a, j, a b\n" +
        ...
        try {
            ...
            while (rs.next()) {
                ...
                functionAndRelatedJoin.setFaId(rs.getInt(1));
                functionAndRelatedJoin.setFaName(rs.getString(2));
                functionAndRelatedJoin.setFuId(rs.getInt(3));
                functionAndRelatedJoin.setFuName(rs.getString(4));
                functionAndRelatedJoin.setJoinType(rs.getInt(5));
                functionAndRelatedJoin.setjFuId(rs.getInt(6));
                functionAndRelatedJoin.setjFuName(rs.getString(7));
                functionAndRelatedJoin.setjFaId(rs.getInt(8));
                functionAndRelatedJoin.setjFaName(rs.getString(9));
