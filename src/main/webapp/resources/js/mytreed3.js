function drawMytreed3(datasource) {
...
var tip = d3.tip()
  ...
  .offset([-10, 0])
  .html(function(d) {
    return "<strong>Элемент:</strong> <span style='color:red'>" + d.name + "</span>";
  });
  ...
  var vis = d3.select(".d3tree_main").append("svg")
...
function update(source) {
  ...
  nodeEnter.append("svg:circle")
    ...
    nodeEnter.append('text')
        ...
        .attr('y', function(d) { return d.children ? -60 : -10; })
